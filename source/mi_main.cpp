...
#include "mi_utility.cpp"
#include "mi_win32.cpp"
...
int main (int argc, char** argv)
{
        ...
        for (int i=1; i<argc; ++i)
        {
            ...
            if (argv[i][0] == '-')
            {
                ...
                else if (arg.name == "sizes")
                {
                    ...
                    if (options.sizes.empty()) ERROR("No sizes provided with -sizes argument!");
                }
    ...
    if (options.sizes.empty())  ERROR("No icon sizes provided! Specify sizes using: -sizes:x,y,z,w...");
    ...
    return make_icon_win32(options);
}
